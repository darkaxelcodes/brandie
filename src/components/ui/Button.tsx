...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variants = {
    primary: 'bg-gradient-luxury text-white hover:shadow-xl focus:ring-electric-blue shadow-lg font-semibold',
    secondary: 'bg-white text-gray-900 border-2 border-gray-300 hover:border-gray-400 hover:bg-gray-50 focus:ring-gray-500 shadow-md hover:shadow-lg font-semibold',
    ...
    luxury: 'bg-gradient-to-r from-gray-900 to-black text-white hover:from-black hover:to-gray-900 shadow-luxury focus:ring-gray-800 font-semibold'
  }
